...
#define RCC_BJ1            RCC_APB2Periph_GPIOA
#define PORTS_BJ1             GPIOA
#define PINS_BJ1               GPIO_Pin_12

#define RCC_BJ2            RCC_APB2Periph_GPIOA
#define PORTS_BJ2             GPIOA
#define PINS_BJ2               GPIO_Pin_11
// ----------------------------------------------------------------------------
