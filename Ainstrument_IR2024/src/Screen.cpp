...
Screen::Screen(Ainstrument *ainstr1, Ainstrument *ainstr2,
		HistoryData *m_history1, HistoryData *m_history2) {
	// TODO 自动生成的构造函数存根
	this->ainstr = ainstr1;
