...
//				AinstrRun(ainstr1, ff/8 , 1, m_ds.m_wendu[0], 0); //0为恒温温度，1为探测器温度
				AinstrRun(ainstr1,m_xiangguan.m_R*10000,m_xiangguan.m_A*10000,m_xiangguan.m_CC ,
						m_xiangguan.m_T); //0为恒温温度，1为探测器温度


				timerPWM.outPWM(0,ainstr1.getCanshuZhi(106));
				//m_xiangguan.sendRead();
