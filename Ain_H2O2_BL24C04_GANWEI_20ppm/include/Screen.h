...
class Screen {
public:
	Screen(Ainstrument *ainstr1,Ainstrument *ainstr2, Ainstrument *ainstr3, HistoryData *m_history1,HistoryData *m_history2,HistoryData *m_history3);
	virtual ~Screen();
	void run(); //每秒运行一次
	void show();
	void start();
